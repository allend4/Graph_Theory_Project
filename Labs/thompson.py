...
class State:
    ...
    def __init__(self, label, arrows, accept):
        """ label is the arrow labels, arrows is a list of states to point to, 
        accept is a boolean as to whether this is an accept state. """
        self.label = label
        self.arrows = arrows
        self.accept = accept
...
class NFA:
    ...
    def match(s):
        """ Return True if is accepted by this NFA """
